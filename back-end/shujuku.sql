...
INSERT INTO `sys_menu` VALUES ('55', '0', 'demo', '1', null, null, '1', '2018-01-16 16:22:52', '0000-00-00 00:00:00', null, '0', '演示页面');
...
INSERT INTO `sys_menu` VALUES ('57', '55', 'dict_demo', '2', 'demo/dict_demo', 'pound', '1', '2018-01-16 16:28:23', '0000-00-00 00:00:00', null, '0', '数据字典演示');
...
INSERT INTO `sys_menu` VALUES ('59', '55', 'md-editor', '3', 'demo/my-components/markdown-editor/markdown-editor', 'pound', '1', '2018-01-16 16:34:17', '0000-00-00 00:00:00', null, '0', 'Markdown编辑器');
...
INSERT INTO `sys_menu` VALUES ('61', '55', 'draggable-list', '5', 'demo/my-components/draggable-list/draggable-list', 'arrow-move', '1', '2018-01-16 16:35:24', '0000-00-00 00:00:00', null, '0', '可拖拽列表');
INSERT INTO `sys_menu` VALUES ('62', '55', 'area-linkage', '6', 'demo/my-components/area-linkage/area-linkage', 'ios-more', '1', '2018-01-16 16:36:16', '0000-00-00 00:00:00', null, '0', '城市级联');
INSERT INTO `sys_menu` VALUES ('63', '55', 'count-to', '8', 'demo/my-components/count-to/count-to', 'arrow-graph-up-right', '1', '2018-01-16 16:36:46', '0000-00-00 00:00:00', null, '0', '数字渐变');
INSERT INTO `sys_menu` VALUES ('64', '55', 'shopping', '9', 'demo/advanced-router/component/shopping-info', 'ios-cart', '1', '2018-01-16 16:38:14', '0000-00-00 00:00:00', null, '0', '购物详情');
INSERT INTO `sys_menu` VALUES ('65', '0', 'international', '3', 'demo/international/international', 'earth', '1', '2018-01-16 16:38:59', '0000-00-00 00:00:00', null, '0', '国际化');
INSERT INTO `sys_menu` VALUES ('66', '0', 'error-page', '4', 'error-page/error-page', 'android-sad', '1', '2018-01-16 16:39:29', '0000-00-00 00:00:00', null, '0', '错误页面');
INSERT INTO `sys_menu` VALUES ('67', '0', 'form', '5', null, 'android-checkbox', '1', '2018-01-16 16:40:19', '0000-00-00 00:00:00', null, '0', '表单编辑');
INSERT INTO `sys_menu` VALUES ('68', '67', 'artical-publish', '1', 'demo/form/article-publish/article-publish', 'compose', '1', '2018-01-16 16:40:45', '0000-00-00 00:00:00', null, '0', '文章发布');
INSERT INTO `sys_menu` VALUES ('69', '67', 'workflow', '2', 'demo/form/work-flow/work-flow', 'arrow-swap', '1', '2018-01-16 16:41:07', '0000-00-00 00:00:00', null, '0', '工作流');
INSERT INTO `sys_menu` VALUES ('70', '67', 'preview', '3', 'demo/form/article-publish/preview', 'arrow-swap', '1', '2018-01-16 16:41:32', '0000-00-00 00:00:00', null, '0', '文章');
INSERT INTO `sys_menu` VALUES ('71', '0', 'tables', '6', null, 'ios-grid-view', '1', '2018-01-16 16:43:53', '0000-00-00 00:00:00', null, '0', '表格');
INSERT INTO `sys_menu` VALUES ('72', '71', 'dragable-table', '1', 'demo/tables/dragable-table', 'arrow-move', '1', '2018-01-16 16:44:21', '0000-00-00 00:00:00', null, '0', '可拖拽排序');
INSERT INTO `sys_menu` VALUES ('73', '71', 'editable-table', '2', 'demo/tables/editable-table', 'edit', '1', '2018-01-16 16:44:49', '0000-00-00 00:00:00', null, '0', '可编辑表格');
INSERT INTO `sys_menu` VALUES ('74', '71', 'searchable-table', '3', 'demo/tables/searchable-table', 'search', '1', '2018-01-16 16:45:42', '0000-00-00 00:00:00', null, '0', '可搜索表格');
INSERT INTO `sys_menu` VALUES ('75', '71', 'exportable-table', '4', 'demo/tables/exportable-table', 'code-download', '1', '2018-01-16 16:46:54', '0000-00-00 00:00:00', null, '0', '表格导出数据');
INSERT INTO `sys_menu` VALUES ('76', '71', 'table-to-image', '5', 'demo/tables/table-to-image', 'images', '1', '2018-01-16 16:47:23', '0000-00-00 00:00:00', null, '0', '表格转图片');
INSERT INTO `sys_menu` VALUES ('77', '0', 'advanced-router', '7', null, 'ios-infinite', '1', '2018-01-16 16:48:10', '0000-00-00 00:00:00', null, '0', '高级路由');
INSERT INTO `sys_menu` VALUES ('78', '77', 'mutative-router', '1', 'demo/advanced-router/mutative-router', 'link', '1', '2018-01-16 16:48:32', '0000-00-00 00:00:00', null, '0', '动态路由');
INSERT INTO `sys_menu` VALUES ('79', '77', 'argument-page', '2', 'demo/advanced-router/argument-page', 'android-send', '1', '2018-01-16 16:48:53', '0000-00-00 00:00:00', null, '0', '带参页面');
